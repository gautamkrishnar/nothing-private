describe('Nothing Private e2e tests', function() {
    ...
    it('Initial page loading and API Calls', function() {
        cy.server();
        cy.route('GET', 'https://nothing-private-api.gautamkrishnar.com/safedb.php*').as('safeDbAPI');
    ...
    it('Functionality test: Typing on input box and clicking "see the magic" button', function() {
        ...
        cy.server();
        cy.route('https://nothing-private-api.gautamkrishnar.com/safedb.php*').as('safeDbAPI');
    ...
    it('Functionality test: Clicking on "Forget me" button', function() {
        cy.server();
        cy.route('GET', 'https://nothing-private-api.gautamkrishnar.com/forgetme.php*').as('forgetMeAPI');
